  ...
  describe '#valid?' do
    context 'presence' do
      it 'must have a code' do
        ...
        new_product = Product.create(depth: 10, height: 20, width: 20, weight: 15, sku: 'ASD231ASDS',
                                     address: 'Rua viva, 10')
        order = Order.new(receiver_name: 'Pedro', delivery_address: 'Rua das entregas, 700', company: new_company,
                          product: new_product)
      ...
      it 'must have a delivery_address' do
        ...
        new_product = Product.create(depth: 10, height: 20, width: 20, weight: 15, sku: 'ASD231ASDS',
                                     address: 'Rua viva, 10')
        order = Order.new(receiver_name: 'Pedro', delivery_address: '', company: new_company, product: new_product)
    ...
    context 'uniqueness' do
      it 'false when code already exist' do
        ...
        new_product = Product.create(depth: 10, height: 20, width: 20, weight: 15, sku: 'ASD231ASDS',
                                     address: 'Rua viva, 10')
        order_one = Order.create(receiver_name: 'Pedro', delivery_address: 'Rua das entregas, 700',
                                 company: new_company, product: new_product)
        order_two = Order.new(receiver_name: 'Pedro', delivery_address: 'Rua das entregas, 700', company: new_company,
                              product: new_product)
