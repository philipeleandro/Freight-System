  ...
  describe '#valid?' do
    context 'presence' do
      ...
      it 'false when days does not has a value' do
        ...
        company = Company.create(corporate_name: 'Impact', domain: 'impact.com.br', brand_name: 'Impact', address: 'Rua das flores, 1000', cnpj: '12345678974568', freight: 100, threshold: 500, user: admin)
        user = User.create(name: 'Impact', email: 'user@impact.com.br', password: '12345678')
        delivery_time = DeliveryTime.create(min_distance: 0, max_distance: 20, days: "", company: company)
    ...
    context 'greater' do
      it 'min_volue must be greater or equal than 0' do
        ...
        company = Company.create(corporate_name: 'Impact', domain: 'impact.com.br', brand_name: 'Impact', address: 'Rua das flores, 1000', cnpj: '12345678974568', freight: 100, threshold: 500, user: admin)
        user = User.create(name: 'Impact', email: 'user@impact.com.br', password: '12345678')
        delivery_time = DeliveryTime.create(min_distance: 0, max_distance: 20, days: 2, company: company)
        delivery_time_two = DeliveryTime.create(min_distance: 1, max_distance: 20, days: 2, company: company)
        delivery_time_three = DeliveryTime.create(min_distance: -1, max_distance: 20, days: 2, company: company)
      ...
      it 'false when days is less than 0' do
        ...
        company = Company.create(corporate_name: 'Impact', domain: 'impact.com.br', brand_name: 'Impact', address: 'Rua das flores, 1000', cnpj: '12345678974568', freight: 100, threshold: 500, user: admin)
        user = User.create(name: 'Impact', email: 'user@impact.com.br', password: '12345678')
        delivery_time = DeliveryTime.create(min_distance: 0, max_distance: 20, days: -1, company: company)
      ...
      it 'false when max_distance is less than 0' do
        ...
        company = Company.create(corporate_name: 'Impact', domain: 'impact.com.br', brand_name: 'Impact', address: 'Rua das flores, 1000', cnpj: '12345678974568', freight: 100, threshold: 500, user: admin)
        user = User.create(name: 'Impact', email: 'user@impact.com.br', password: '12345678')
        delivery_time = DeliveryTime.create(min_distance: 0, max_distance: 0, days: 2, company: company)
      ...
      it 'false when max_distance is less than min_distance' do
        ...
        company = Company.create(corporate_name: 'Impact', domain: 'impact.com.br', brand_name: 'Impact', address: 'Rua das flores, 1000', cnpj: '12345678974568', freight: 100, threshold: 500, user: admin)
        user = User.create(name: 'Impact', email: 'user@impact.com.br', password: '12345678')
        delivery_time = DeliveryTime.create(min_distance: 0, max_distance: -1, days: 2, company: company)
