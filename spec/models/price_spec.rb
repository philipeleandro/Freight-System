  ...
  describe '#valid?' do
    context 'presence' do
      it 'must have a min volume' do
        ...
        price = Price.create(min_volume: '', max_volume: 20, min_weight: 10, max_weight: 20, value: 50,
                             company: new_company)
      ...
      it 'must have a value' do
        ...
        new_company = Company.create(corporate_name: 'Impact', domain: 'impact.com.br', brand_name: 'Impact',
                                     ...
                                     threshold: 500, user: admin)
        User.create(name: 'Impact', email: 'user@impact.com.br', password: '12345678')
        price = Price.create(min_volume: 15, max_volume: 20, min_weight: 10, max_weight: 20, value: '',
                             company: new_company)
    ...
    context 'greater' do
      it 'min_volue must be greater than 0' do
        ...
        new_company = Company.create(corporate_name: 'Impact', domain: 'impact.com.br', brand_name: 'Impact',
                                     ...
                                     threshold: 500, user: admin)
        User.create(name: 'Impact', email: 'user@impact.com.br', password: '12345678')
        price = Price.create(min_volume: 0, max_volume: 20, min_weight: 10, max_weight: 20, value: 50,
                             company: new_company)
      ...
      it 'value must be greater than 0' do
        ...
        new_company = Company.create(corporate_name: 'Impact', domain: 'impact.com.br', brand_name: 'Impact',
                                     ...
                                     threshold: 500, user: admin)
        User.create(name: 'Impact', email: 'user@impact.com.br', password: '12345678')
        price = Price.create(min_volume: 15, max_volume: 20, min_weight: 10, max_weight: 20, value: 0,
                             company: new_company)
